  ...
  return (
    <>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            className="fixed bottom-24 right-6 w-80 h-96 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 z-40"
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <div className="flex-1 bg-gray-100 dark:bg-gray-700 rounded-lg p-3">
                    <p className="text-sm text-gray-900 dark:text-white">
                      Hello! I'm your AI writing assistant. How can I help you with your manuscript today?
                    </p>
                  </div>
                </div>
              </div>
